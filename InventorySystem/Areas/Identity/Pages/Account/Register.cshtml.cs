        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(user.Role == null) //The receive value from Page
                    {
                    ...
                    /*
                     * Here's the reason why the erro to send Emial when attempting to redirect to Register view 
                    */
                    ...
                    else
                    {
                        ...
                        {
                            //Admin is registering to a new user
                            /* Redirecting to a View where the user are management */
